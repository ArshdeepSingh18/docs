...
In this example, the node functions (`my_app_node` and `myAppNode`) can contain calls to any framework or library. The LangGraph structure simply provides the deployment interface and orchestration layer.
